...
(function (t, e) {
    ...
    var n, i = t.document;
    n = function () {
        var n, s, r, o, a, l, c, u, f, d, h, p, y = {}, b = {}, m = !1, v = {ENTER: 13, ESC: 27, SPACE: 32}, g = [];
        return b = {
            buttons: {
            ...
            for (t in o)if (r.style[t] !== e) {
                n = o[t], s = !0;
                break
            }
            return {type: n, supported: s}
        }, n = function (t) {
            ...
            build: function (t) {
                var e = "", n = t.type, i = t.message, s = t.cssClass || "";
            ...
            alert: function (t, e, n) {
            ...
            }, extend: y.extend, init: y.init, log: function (t, e, n) {
                ...
                y.set(t)
            }, labels: y.labels, debug: y.handleErrors
        }
