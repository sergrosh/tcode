...
<div class="controls">
    <div class="btn-toolbar" data-role="editor-toolbar" data-target="#inputNoteDescription">
        <div class="btn-group">
        ...
        <div class="btn-group">
            <a class="btn" data-edit="justifyleft" title="" data-original-title="Align Left (Ctrl/Cmd+L)"><i
    ...
    <div id="inputNoteDescription" contenteditable="true">
        <c:out value="${note.description}" escapeXml="false"/>
    </div>
    <script>
        $(function () {
            $('#inputNoteDescription').wysiwyg();
        });
    </script>
</div>
